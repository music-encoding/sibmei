...
function InitElementAndAttributeTemplates () {
    ...
    Self._property:ClefTemplates = CreateDictionary(
        ...
        'clef.percussion_2',            @Element('clef', @Attrs('shape', 'perc', 'glyph.auth', 'smufl', 'glyph.num', SmuflHex.unpitchedPercussionClef2)),
        ...
        'clef.treble.down.8.bracketed', @Element('clef', @Attrs('shape', 'G', 'line', '2', 'dis', '8', 'dis.place', 'below', 'glyph.auth', 'smufl', 'glyph.num', SmuflHex.gClef8vbParens)),
...
function InitChordCharacterMaps () {
    ...
    Self._property:ChordFontMap = CreateDictionary(
        ...
        ':', @Element('rend', rendSup, 'OMIT'),
        '™', @Element('rend', @Attrs('rend', 'sup smcaps'), 'n'),
        'œ', @Element('rend', @Attrs('rend', 'sup smcaps'), 'o'),
