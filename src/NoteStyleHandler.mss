function InitNoteStyleAttributes () {
    // Name-codepoint mappings taken from SMuFL's glyphnames.json
    // https://github.com/w3c-cg/smufl/blob/gh-pages/metadata/glyphnames.json
    ...
    RegisterNoteStyle('NoteStyle', BeatWithoutStemNoteStyle,      0,   511, @Attrs('head.shape', smufl.noteheadSlashVerticalEnds, 'head.auth', 'smufl', 'stem.len', '0', 'type', 'beat-slash no-ledger')); // 3
    RegisterNoteStyle('NoteStyle', BeatWithoutStemNoteStyle,      512, 0,   @Attrs('head.shape', smufl.noteheadSlashDiamondWhite, 'head.auth', 'smufl', 'stem.len', '0', 'type', 'beat-slash no-ledger')); // 3
    RegisterNoteStyle('NoteStyle', BeatNoteStyle,                 0,   511, @Attrs('head.shape', smufl.noteheadSlashVerticalEnds, 'head.auth', 'smufl', 'type', 'beat-slash no-ledger')); // 4
    RegisterNoteStyle('NoteStyle', BeatNoteStyle,                 512, 0,   @Attrs('head.shape', smufl.noteheadSlashDiamondWhite, 'head.auth', 'smufl', 'type', 'beat-slash no-ledger')); // 4
    ...
    RegisterNoteStyle('NoteStyle', ArrowDownNoteStyle,            0,   511, @Attrs('head.shape', smufl.noteheadTriangleDownBlack, 'head.auth', 'smufl', 'stem.pos', 'center', 'type', 'isotriangle-down no-ledger')); // 13
    RegisterNoteStyle('NoteStyle', ArrowDownNoteStyle,            512, 0,   @Attrs('head.shape', smufl.noteheadTriangleDownWhite, 'head.auth', 'smufl', 'stem.pos', 'center', 'type', 'isotriangle-down no-ledger')); // 13
    ...
    RegisterNoteStyle('NoteStyle', InvertedTriangleNoteStyle,     0,   511, @Attrs('head.shape', smufl.noteheadTriangleDownBlack, 'head.auth', 'smufl', 'type', 'isotriangle-down')); // 15
    RegisterNoteStyle('NoteStyle', InvertedTriangleNoteStyle,     512, 0,   @Attrs('head.shape', smufl.noteheadTriangleDownWhite, 'head.auth', 'smufl', 'type', 'isotriangle-down')); // 15
    ...
    RegisterNoteStyle('NoteStyle', ShapedNote3NoteStyle,          0,   511, @Attrs('head.shape', smufl.noteheadDiamondBlack, 'head.auth', 'smufl', 'type', 'diamond')); // 18
    RegisterNoteStyle('NoteStyle', ShapedNote3NoteStyle,          512, 0,   @Attrs('head.shape', smufl.noteheadDiamondWhite, 'head.auth', 'smufl', 'type', 'diamond')); // 18
    ...
    RegisterNoteStyle('NoteStyle', ShapedNote4StemUpNoteStyle,    0,   511, @Attrs('head.shape', smufl.noteheadTriangleUpRightBlack, 'head.auth', 'smufl', 'type', 'triangle-up-right')); // 19
    RegisterNoteStyle('NoteStyle', ShapedNote4StemUpNoteStyle,    512, 0,   @Attrs('head.shape', smufl.noteheadTriangleUpRightWhite, 'head.auth', 'smufl', 'type', 'triangle-up-right')); // 19
    ...
    RegisterNoteStyle('NoteStyle', ShapedNote4StemDownNoteStyle,  0,   511, @Attrs('head.shape', smufl.noteheadTriangleLeftBlack, 'head.auth', 'smufl', 'type', 'triangle-down-left')); // 23
    RegisterNoteStyle('NoteStyle', ShapedNote4StemDownNoteStyle,  512, 0,   @Attrs('head.shape', smufl.noteheadTriangleLeftWhite, 'head.auth', 'smufl', 'type', 'triangle-down-left')); // 23
    ...
    // Cross 2
    RegisterNoteStyle('NoteStyle', 24,                            0,   511, @Attrs('head.shape', smufl.noteheadXBlack, 'head.auth', 'smufl', 'type', 'x')); // 24
    RegisterNoteStyle('NoteStyle', 24,                            512, 0,   @Attrs('head.shape', smufl.noteheadCircleX, 'head.auth', 'smufl', 'type', 'x circled')); // 24
    ...
    // Large cross
    RegisterNoteStyle('NoteStyle', 26,                            0,   511, @Attrs('head.shape', smufl.noteheadSlashDiamondWhite, 'head.auth', 'smufl', 'type', 'beat-cross')); // 26
    RegisterNoteStyle('NoteStyle', 26,                            512, 0,   @Attrs('head.shape', smufl.noteheadDiamondWhite, 'head.auth', 'smufl', 'type', 'beat-cross')); // 26
    ...
    // Cross (ornate)
    RegisterNoteStyle('NoteStyle', 29,                            0,   511, @Attrs('head.shape', smufl.noteheadXOrnate, 'head.auth', 'smufl', 'type', 'ornate-x')); // 29
    RegisterNoteStyle('NoteStyle', 29,                            512, 0,   @Attrs('head.shape', smufl.noteheadVoidWithX, 'head.auth', 'smufl', 'type', 'ornate-x')); // 29
    // Ping
