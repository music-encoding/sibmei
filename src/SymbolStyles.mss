...
function InitModifierSymbols () {
    ...
    modifierMap = CreateDictionary(
        ...
        '212', CreateSparseArray('Artic', CreateDictionary('artic','ten'),CreateDictionary('place','above')),   //ten above
        '214', CreateSparseArray('Artic', CreateDictionary('artic','marc'),CreateDictionary('place','above')),  //marc above
        '217', CreateSparseArray('Artic', CreateDictionary('artic','upbow'),CreateDictionary('place','above')), //upbow above
        '218', CreateSparseArray('Artic', CreateDictionary('artic','dnbow'),CreateDictionary('place','above')), //dnbow above
        '233', CreateSparseArray('Artic', CreateDictionary('artic','upbow'),CreateDictionary('place','below')), //upbow below
        '234', CreateSparseArray('Artic', CreateDictionary('artic','dnbow'),CreateDictionary('place','below')), //dnbow below
